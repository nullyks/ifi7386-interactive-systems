...
Suitable questions include whether:

- a first-time user notices and understands the feedback;
- the first action is discoverable without explanation;
- a physical input makes sense in the intended setting;
...
Capture a photo or digital image of the prototype. Record:

- the prototype question;
- what is represented;
- what is intentionally absent;
- one observation from the rehearsal;
- one question that remains.

## Worked example

### Scenario: shared study-room comfort cue

1. Four students have been working in a small study room for an hour.
2. One student wants the group to continue without losing concentration.
3. The simulated comfort value crosses a threshold.
4. The system changes from “Comfortable” to “Action suggested.”
5. A labelled physical cue and web status change to “Open window or take a short break.”
6. The student notices the cue, opens the window, and later sees the state return to “Comfortable.”

### Prototype question

> Can a first-time user interpret the state change and identify an appropriate next action without spoken guidance?
...
- What did the test person appear to think the system was doing?
- Which feedback was noticed, understood, or missed?
- Which part of the scenario depended on an unsupported assumption?
- Did the prototype represent more detail than the question required?
- What should the next prototype or contextual inquiry investigate?
...
- [Lim, Stolterman, and Tenenberg (2008), open PDF](https://faculty.washington.edu/jtenenbg/publications/limAnatomyOfPrototypes-tochi2008.pdf)
- [The Open University: sketching and prototyping within interaction design](https://www.open.edu/openlearn/mod/oucontent/view.php?id=66703&section=1)

[Next activity →](08-pitch-and-peer-feedback.md)
